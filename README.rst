...
Since this repository isn't the *official* code for any presentation, you take responsibility for the *correctness* of the implementations (although we've made every effort to ensure that the code is well tested).
...
If your work specifically revolves around adversarial machine learning for wireless communications, consider citing my Master Thesis completed at Virginia Tech where the majority of this code originated from.
The work there will provide a deep dive into adversarial evasion attacks on wireless signal classification systems.

.. code:: latex

    @phdthesis{flowers2019adversarial,
        title={Adversarial RFML: Evading Deep Learning Enabled Signal Classification},
        author={Flowers, Bryse Austin},
        year={2019},
